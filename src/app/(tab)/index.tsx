...
// import { Alert, LayoutAnimation, Pressable, Text, TextInput, TouchableOpacity, View } from 'react-native';
...
//                                         <ScaleDecorator drag={drag} isActive={isActive}>
//                                             <View style={tw` px-5 flex-row gap-2 items-center border-b-[1px] border-gray py-3 `}>
//                                                 <TouchableOpacity
//                                                     onLongPress={drag}
//                                                     disabled={isActive}
//                                                     style={[
