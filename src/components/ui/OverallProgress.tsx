import { IconArrowTop, IconCup, IconDate, IconGroup, IconRedArrow, IconsGrowth } from '@/assets/icons';
            ...
            <View style={tw`bg-primaryBg rounded-xl p-5 shadow-lg shadow-blackish my-2 `}>
                ...
                <View style={tw`flex-col justify-between  gap-1 `}>
                    <View style={tw`flex-row justify-between items-center `}>
                        ...
                        <TouchableOpacity
                            style={tw`bg-gray rounded-md p-2`}
                            activeOpacity={0.7}
                        >
                            <SvgXml xml={IconsGrowth} width={22} height={22} />
                        </TouchableOpacity>
                    </View>

                    <View>
                        {/* Progress Number */}
                        <Text style={tw`text-blackish text-xl font-montserrat-700 `}>
                            44%
                        </Text>
                    </View>
                    ...
                    <View style={tw`flex-col justify-between  gap-1 `}>
                        ...
                        <View style={tw`flex-row items-center mt-1`}>
                            <SvgXml xml={IconArrowTop} width={12} height={12} />
                            <Text style={tw`text-xs text-green-600 ml-1 font-montserrat-400`}>
                                12% from last week
                            </Text>
                        </View>
                    </View>
            ...
            <View style={tw`bg-primaryBg rounded-xl p-5 shadow-lg shadow-blackish my-2 `}>
                ...
                <View style={tw`flex-col justify-between  gap-1 `}>
                    <View style={tw`flex-row justify-between items-center `}>
                        ...
                        // activeOpacity={0.7}
                        >
                            <SvgXml xml={IconCup} width={22} height={22} />
                        </TouchableOpacity>
                    </View>
                ...
                <View style={tw`flex-col justify-between  gap-1 `}>
                    <View style={tw`flex-row justify-between items-center `}>
                        ...
                        <TouchableOpacity
                            ...
                            activeOpacity={0.7}
                        >
                            <SvgXml xml={IconGroup} width={22} height={22} />
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={tw`flex-col justify-between  gap-1 `}>
                        ...
                        {/* Bottom Hint */}
                        <View style={tw`flex-row items-center mt-1`}>
                            <SvgXml xml={IconRedArrow} width={12} height={12} />
                            <Text style={tw`text-xs text-[#ff0800] ml-1 font-montserrat-400`}>
                                5% from last week
                            </Text>
                        </View>
                    </View>
